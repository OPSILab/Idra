...
@SqlResultSetMapping(name = "SearchStatisticsResult", classes = {
		@ConstructorResult(targetClass = SearchStatisticsResult.class, columns = {
				@ColumnResult(name = "live", type = Integer.class), @ColumnResult(name = "cache", type = Integer.class),
...
public class SearchStatistics {
	...
	public SearchStatistics(String country, int live, int cache, int sparql, int day, int week, int month, int year) {
		super();
	...
	public String toString() {
		return "SearchStatistics [id=" + id + ", country=" + country + ", values: {cache: " + cache + ", live: " + live
				+ ", sparql: " + sparql + "}]";
	}
