...
public class ODMSStatistics {
	...
	public ODMSStatistics(int nodeID, String name, int day, int month, int year, int added_datasets,
			int updated_datasets, int deleted_datasets, int added_RDF, int updated_RDF, int deleted_RDF) {
		super();
		this.nodeID = nodeID;
		this.name = name;
		this.day = day;
	...
	public String toString() {
		return "ODMSStatistics [id=" + id + ", nodeID=" + nodeID + ", day=" + day + ", month=" + month + ", year="
				+ year + "]";
	}
