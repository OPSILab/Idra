...
public enum IdraProperty {
  ...
  IDRA_RELEASE_TIMESTAMP("idra.release.timestamp"), DB_HOST("idra.db.host"),
  DB_HOST_MIN("idra.db.host.min"), DB_NAME("idra.db.name"), DB_USERNAME("idra.db.user"),
  DB_PASSWORD("idra.db.password"),
  HTTP_PROXY_ENABLED("http.proxyEnabled"), HTTP_PROXY_HOST("http.proxyHost"),
  HTTP_PROXY_USER("http.proxyUser"), 
  HTTP_PROXY_PORT("http.proxyPort"),
  HTTP_PROXY_PASSWORD("http.proxyPassword"),
  HTTP_PROXY_NONPROXYHOSTS("http.nonProxyHosts"), HTTPS_PROXY_HOST("https.proxyHost"),
  HTTPS_PROXY_USER("https.proxyUser"), 
  HTTPS_PROXY_PORT("https.proxyPort"), HTTPS_PROXY_PASSWORD("https.proxyPassword"),
  HTTPS_PROXY_NONPROXYHOSTS("https.nonProxyHosts"), LOAD_CACHE_FROM_DB("idra.cache.loadfromdb"),
  SYNCH_ON_START("idra.synch.onstart"), ODMS_DUMP_FILE_PATH("idra.odms.dump.file.path"),
  ODMS_DUMP_FILE_PREFIX("idra.odms.dump.file.prefix"), DUMP_FILE_PATH("idra.dump.file.path"),
  DUMP_FILE_NAME("idra.dump.file.name"), 
  DUMP_FORMAT("idra.dump.format"), DUMP_PROFILE("idra.dump.profile"),
  DUMP_PERIOD("idra.dump.period"), 
  DUMP_ZIP_FILE("idra.dump.file.zip"), DUMP_ON_START("idra.dump.onstart"),
  ENABLE_RDF("idra.lod.enable"), 
  SESAME_REPO_NAME("idra.lod.repo.name"), SESAME_SERVER_URI("idra.lod.server.uri"),
  SESAME_ENDPOINT("idra.lod.server.uri.query"), 
  WEB_CONNECTOR_DEFAULT_STOP_VALUES("idra.scraper.defaultStopValues"),
  ENABLE_STATISTICS("idra.statistics.enable"), AUTHENTICATION_METHOD("idra.authentication.method"),
  ...
  PREVIEW_TIMEOUT("idra.preview.timeout"), PREVIEW_MAX_SIZE("idra.preview.fileSize");
