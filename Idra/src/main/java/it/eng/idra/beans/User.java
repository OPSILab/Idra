...
public class User {
	...
	public User(int id,String username, String password,String firstname, String lastname,String email, Date registerDate, Date lastAccess){
		
		try{ setUsername(username); }
		catch(Exception e){
