To get started, <a href="https://github.com/OPSILab/Idra/blob/master/idra-individual-cla.pdf">sign the Contributor License Agreement</a>.
...
-   If you open a pull request, you must sign the [Individual Contributor License Agreement](https://github.com/OPSILab/Idra/blob/master/idra-individual-cla.pdf) by stating in a comment _"I have read the CLA Document and I hereby sign the CLA"_

## How to contribute

If you'd like to contribute, start by searching through the [issues](https://github.com/OPSILab/Idra/issues) and [pull requests](https://github.com/OPSILab/Idra/pulls) to see whether someone else has raised a similar idea or question.
...
Discussions about the Open Source Guides take place on this repository's [Issues](https://github.com/OPSILab/Idra/issues) and [Pull Requests](https://github.com/OPSILab/Idra/pulls) sections. Anybody is welcome to join these conversations.
...
3.  Add the main idra repository as a remote to your forked repository (use any name for your remote
    repository, it does not have to be idra, although we will use it in the next steps):
...
Contributions following this guidelines will be added to the `master` branch, and released in the next version.
